...
//         argv[0]); errx(EXIT_FAILURE, "Detect the grid and the wordlist in a
//         picture.\n");
//     }
//
...
//         wand, ez.words.x_min, ez.words.y_min, ez.words.x_max -
//         ez.words.x_min, ez.words.y_max - ez.words.y_min, &words_chars
//     );
//
